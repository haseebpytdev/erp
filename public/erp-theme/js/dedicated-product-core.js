(function(window,document){
  ...
  var core={
    ...
    applyReadOnly:function(r){if(!r)return false;var locked=core.isLocked();r.querySelectorAll('input,select,textarea,button,[role="button"]').forEach(function(el){if(locked){el.disabled=true;el.setAttribute('aria-disabled','true');}else{el.disabled=false;el.removeAttribute('aria-disabled');}});return locked;},
    ...
    refreshBookingState:function(){return core.requestJson(window.location.href,{headers:{Accept:'text/html', 'X-Requested-With':'XMLHttpRequest'}});},
