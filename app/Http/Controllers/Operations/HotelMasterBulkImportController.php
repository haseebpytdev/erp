...
{
    public function __construct(private readonly NativeHotelMasterAuthority $authority) {}
    ...
    public function import(Request $request) { $rows=$this->rows($request); return response()->json(['ok'=>true]+$this->authority->import($rows)); }
