...
final class NativeHotelMasterAuthority
{
    ...
    public function canonicalHotelName(string $name):string{$n=$this->norm($name);$m=['badar al masa'=>'al massa bader hotel','badar al massa'=>'al massa bader hotel','bader al massa'=>'al massa bader hotel','al massa bader'=>'al massa bader hotel','mather al jewar'=>'mather al jiwar','mather al jawar'=>'mather al jiwar'];return $m[$n]??$n;}
