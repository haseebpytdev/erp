...
```text
CURRENT_DEVELOPMENT_RELEASE=ERP-11.3.361
CURRENT_LIVE_RELEASE=ERP-11.3.360
CURRENT_VERSION=ERP-11.3.361
APPLICATION_VERSION=v1.1.33.361-ERP11.3.361
CURRENT_LIVE_VERSION=v1.1.33.360-ERP11.3.360
...
PRODUCTION_STATUS=ERP-11.3.360 LIVE; ERP-11.3.361 DEVELOPMENT / NOT DEPLOYED.
LAST_PACKAGED_RELEASE=ERP-11.3.360
```
...
359_PARTY_STATEMENT_REGRESSION=PASS (30 assertions)
ACCOUNTING_LOGIC_CHANGED=NO
JOURNAL_POSTING_CHANGED=NO
DATABASE_SCHEMA_CHANGED=NO
NEW_MIGRATION_REQUIRED=NO
...
ERP-11.3.358 refines the client-sendable Party Statement header, desktop and
landscape print geometry, and Air ticket/PNR, airline, sector and flight
metadata presentation. The accepted 357 financial projection and active
financial-year advance visibility remain unchanged. No posting, database
...
357_CURRENT_REGRESSION=PASS (53 assertions)
358_PARTY_STATEMENT_REGRESSION=PASS (28 assertions)
BASELINE_TOTAL=109
BASELINE_PASS=71
BASELINE_FAIL=38
358_TOTAL=110
...
ERP-11.3.356 restores native Sales Invoice rendering for GENERAL multi-product
invoices that contain an Air line without misclassifying the invoice as Air-only.
It also keeps report preview documents within their native document boundary,
preserving report reconciliation while avoiding index workspace filters and
...
ERP-11.3.355 normalizes numeric PHP array keys in the operating expense child
target map before strict parent-group resolution. All 130 COA targets and
existing migration safety controls remain unchanged; undefined child parents
fail closed. ERP-11.3.355 introduces a required migration and is not deployed.

ERP-11.3.350 Departure Report and Travel Reports Navigation Corrective

ERP-11.3.350 repairs the structured Departure filter include and removes the
strict release-footer sibling requirement from semantic sidebar insertion.
Reports are inserted only before a uniquely identified SYSTEM sibling and the
sidebar fails closed otherwise; Movement Reports are not synthesized. The
.349 title correction and .348 Arrival/Departure data and presentation remain
preserved. NEW_MIGRATION_REQUIRED=NO.
...
ERP-11.3.342 corrects Travel Report child-route defaults and native-shell
presentation, hardens the server sidebar, and introduces the dedicated Arrival
Report Phase 1 operational page. It provides six movement tabs, operational
arrival columns, booking/hotel/transport enrichment, deterministic CSV export,
browser Print, and a wide report canvas with table-only horizontal scrolling.
Only Arrival is a dedicated finished movement UI; the other five movement
pages and broader report polish remain deferred. Travel Reports remain
operational only with no financial fields, formulas, persistence, database
schema, or migration changes.

ARRIVAL_REGRESSION=PASS (53 assertions)
342_RUNTIME_REGRESSION=PASS (57 assertions)
341_REGRESSION=PASS (7 assertions)
340_REGRESSION=PASS (8 assertions)
339_REGRESSION=PASS (7 assertions)
338_REGRESSION=PASS (244 assertions)
336_REGRESSION=PASS
330_PERMISSION_REGRESSION=PASS
NEW_NODE_FAILURES=0
PHP85_PARSER_GATE=PASS
MIGRATION_CHANGED=NO
DATABASE_SCHEMA_CHANGED=NO
NEW_MIGRATION_REQUIRED=NO

CURRENT_DEVELOPMENT_RELEASE=ERP-11.3.342
CURRENT_LIVE_RELEASE=ERP-11.3.341
CURRENT_VERSION=ERP-11.3.342
APPLICATION_VERSION=v1.1.33.342-ERP11.3.342
...
ERP-11.3.341 makes the TravelReportService query alias explicitly nullable
for PHP 8.5 compatibility. ERP-11.3.340 repaired both startup syntax defects,
but its PHP 8.5.7 server preflight reported the implicit-nullability
deprecation; .340 was not packaged or deployed. The .341 exact candidate
passed the server parser preflight for all six changed PHP files. No business
logic, formulas, schema, database change or migration is included.

SERVER_PHP_VERSION=8.5.7
SERVER_PHP_SAPI=litespeed
SERVER_PHP_FILES_CHECKED=6
SERVER_SOURCE_IDENTITY_FAILURES=0
SERVER_TEMP_WRITE_FAILURES=0
SERVER_PHP_PARSER_FAILURES=0
SERVER_TEMP_FILES_REMAINING=0
SERVER_PARSER_GATE=PASS
341_REGRESSION=PASS (7 assertions)
NEW_MIGRATION_REQUIRED=NO

CURRENT_DEVELOPMENT_RELEASE=ERP-11.3.341
CURRENT_LIVE_RELEASE=ERP-11.3.337
CURRENT_VERSION=ERP-11.3.341
APPLICATION_VERSION=v1.1.33.341-ERP11.3.341
CURRENT_RELEASE_PACKAGE_STATUS=FINALIZED
DEPLOYED=NO
NEW_MIGRATION_REQUIRED=NO
LAST_PACKAGED_RELEASE=ERP-11.3.339

ERP-11.3.340 Travel Reports Remaining Startup Parse Hotfix

ERP-11.3.340 repairs the remaining production startup ParseError in
app/Services/Reports/TravelReportService.php line 101 by restoring one
missing closing parenthesis in orderedChildRows(). The .338 and .339
deployments failed startup and were rolled back; .337 is live again and .340
has not been deployed or production-verified. No report logic, formulas,
schema, database change or migration is included.

340_REGRESSION=PASS (8 structural assertions)
339_REGRESSION=PASS (7 assertions)
338_REGRESSION=PASS (244 assertions)
NEW_MIGRATION_REQUIRED=NO

CURRENT_DEVELOPMENT_RELEASE=ERP-11.3.340
CURRENT_LIVE_RELEASE=ERP-11.3.337
CURRENT_VERSION=ERP-11.3.340
APPLICATION_VERSION=v1.1.33.340-ERP11.3.340
CURRENT_RELEASE_PACKAGE_STATUS=NOT_FINALIZED
DEPLOYED=NO
NEW_MIGRATION_REQUIRED=NO
LAST_PACKAGED_RELEASE=ERP-11.3.339
...
accounting, workflow, Day-One/Day-Zero, print/voucher, schema or migration
...
desktop / 16px responsive gutter, so working content begins after that gutter
and the normal utility topbar's unchanged negative compensation resolves at the
main/sidebar boundary. The .252 208px grid track, zero duplicate standard-host
padding, booking-focus one-column/zero-main-gutter contract, Dashboard/System
Health internals, booking/accounting behavior, Day-One/Day-Zero, print/voucher
layouts and schema remain unchanged. No migration is required.
