...
ok(version === 'v1.1.33.314-ERP11.3.314', 'ERP-11.3.259 packaged release metadata is current');
...
ok(!airMountBody.includes('etBookingWorkspaceContext113305') && airMountBody.includes('etgpAirDedicatedIntegration113314.getBookingId') && airMountBody.includes('etgpAirData113314.load'), 'Air mount resolves identity and data through explicit adapters');
