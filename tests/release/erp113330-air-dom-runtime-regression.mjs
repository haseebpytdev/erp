...
const exposed=source.replace("window.etDedicatedAirProduct={mount:mountAir,getState:function(){return {saveInFlight:airLifecycle.saveInFlight,dirty:airLifecycle.dirty,draftPending:airLifecycle.draftPending,bookingId:airLifecycle.bookingId};}};", "window.__test={etgpAirSearchableAirline113330,etgpAirDefaultSegmentType113329,etgpAirIsBlankUnsavedSegment113330,etgpAirNormalizeBlankSegments113330};$&");
