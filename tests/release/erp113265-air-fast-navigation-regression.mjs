...
ok(navigation.includes("target=launcher.closest('main')") && navigation.includes("mountedShellMain.setAttribute('class','main')") && navigation.includes("mountedContent.setAttribute('class','content')") && navigation.includes('parent.replaceChild(mountedShellMain,target)') && navigation.includes('mountedShellMain:mountedShellMain') && navigation.includes('mountedRoot:mountedRoot'), 'fast navigation recreates the direct shell/content ancestry with rollback state');
