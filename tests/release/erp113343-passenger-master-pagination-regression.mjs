...
ok(controller.includes('$passportNeedle = UnifiedGroupPackageDataSource::normalizePassport($query)') && source.includes('normalizePassport'), 'search uses canonical logical passport normalization');
