...
ok(uiPolish.includes('data-et-travel-master-ui="113289"') && uiPolish.includes('et-tm-ui-113289'), 'UI polish marker');
...
ok(uiPolish.includes('et-tm-ui-grid-113289') && uiPolish.includes('et-tm-ui-field'), 'field classes are applied with safe grid');
