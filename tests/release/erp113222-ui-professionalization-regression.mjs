...
ok(!js.includes("shellDashboard.textContent = 'Easy Ticket ERP'"), 'topbar title is server-rendered without post-load rewrite');
...
ok(version === 'v1.1.33.306-ERP11.3.306', 'packaged release version is current');
