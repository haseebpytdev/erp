...
contains(hierarchy, "a.href='/master-data/travel-masters/visa-management?tab=rates'", 'Visa Management deterministic creation');
...
contains(hierarchy, 'normalizedLabels.has(textNorm(a.textContent))', 'normalized anchor comparison');
contains(hierarchy, 'cloneNode(true)', 'child links are cloned');
contains(hierarchy, "airlines.slice(0,2).map", 'Airlines family exact-tab detection');
