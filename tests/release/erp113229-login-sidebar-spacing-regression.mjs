...
ok(finalizer.includes("heading.style.setProperty('margin', '12px 9px 5px', 'important')"), 'section heading has explicit bottom breathing room before first link');
ok(finalizer.includes("heading.style.setProperty('line-height', '1.1', 'important')"), 'section heading line-height avoids visual collision with first row');
...
ok(version === 'v1.1.33.229-ERP11.3.229', 'functional checkpoint does not bump deployed release metadata');
