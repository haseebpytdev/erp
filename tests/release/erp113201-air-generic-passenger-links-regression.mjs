...
ok(creator.includes('reconcileCompleteAirServicesForInvoice($bookingId)'), 'invoice bridge reconciles validated legacy Air links before the unchanged host validator');
ok(!creator.includes('SalesInvoiceService validation'), 'invoice bridge does not alter host SalesInvoiceService validation');
