ERP-11.3.345 Live-UAT Passport, Arrival and Reports Menu Corrective

Active release: v1.1.33.345-ERP11.3.345
...
ERP-11.3.345 is not deployed.
CURRENT_LIVE_RELEASE=ERP-11.3.341
NEW_MIGRATION_REQUIRED=NO

Deployment remains manual cPanel direct upload after final package
certification. No database migration is required for .345.

ERP-11.3.345 scope includes canonical exact passport search, Arrival shared
filter structure repair, and native sidebar host compatibility for the Travel
Reports entry. Existing report routes, calculations, authorization, actions,
pagination, shared filter layout and operational-only data remain unchanged.
...
3. Upload/extract ONE authoritative ERP-11.3.345 ZIP through cPanel.
4. Open System Health & Updates; confirm version v1.1.33.345-ERP11.3.345,
   Database = Connected and schema up to date.
5. Confirm ERP-11.3.345 introduces NO new migration.
...
ERP-11.3.345 is NOT FINALIZED / NOT PACKAGED; it is not deployed.
