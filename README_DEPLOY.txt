ERP-11.3.348 Arrival and Departure Presentation Corrective

ERP-11.3.348 corrects the Travel Reports native shell title, report header
spacing, separate movement date/time presentation and compact desktop filter
bars while preserving the .347 movement sources and professional tabs. No
booking, product, authorization, calculation, persistence, database schema or
migration changes are included.

Active release: v1.1.33.348-ERP11.3.348

ERP-11.3.347 is the current live production release. ERP-11.3.337 was the
